<form action="peluqueros.php?action=<?php echo ($action=='update')?'change&id_peluquero='.$datos['id_peluquero']:'save'; ?>"
     method="post" enctype="multipart/form-data">
<h2 class="title" ><?php echo ($action=='update')?  'Editar': 'Nuevo' ?> Peluquero</h2>     
    <div class="field">
        <label class="label">Nombre del Peluquero</label>
        <div class="control">
            <input class="input" type="text" name="nombre"  required="required" 
            value="<?php echo (isset($datos['peluquero']))? $datos['peluquero']:''; ?>">
        </div>
    </div>
    <div class="field">
    ...
    <div class="field">
        ...
        <div class="control">
            <input class="input" type="numeric" name="numero_telefonico"  required="required" minlength="10" maxlength="10"
