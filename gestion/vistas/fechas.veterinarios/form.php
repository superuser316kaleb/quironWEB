<form action="fechas.veterinario.php?action=<?php echo ($action=='update') ? 'change&id_fecha=' . $datos['id_fecha'] : 'save'; ?>" method="post" enctype="multipart/form-data">
   ...
   <div class="field">
    ...
    <div class="field">
        <label class="label">ID Veterinario</label>
        <div class="control">
            <input class="input" type="number" name="id_veterinario" required="required" readonly="readonly" 
            value="<?php echo (isset($datos['id_veterinario'])) ? $datos['id_veterinario'] : $_GET['id_veterinario']; ?>">
        </div>
    </div>
    <div class="control">
